...
u = [1.432*ones(1,10), zeros(1,10),1.432*ones(1,10), zeros(1,10),1.432*ones(1,10), zeros(1,10),1.432*ones(1,10), zeros(1,10),1.432*ones(1,10), zeros(1,10)];

w = [zeros(1,10), 2.513*ones(1,10),zeros(1,10), 2.513*ones(1,10),zeros(1,10), 2.513*ones(1,10),zeros(1,10), 2.513*ones(1,10),zeros(1,10), 2.513*ones(1,10)];
...
indices_deseados = [1,11,21,31,41,51,61,71,81,91,100];
